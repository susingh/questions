...
namespace Questions.IK
{
    ...
    class Adhoc : IQuestion
    {
        ...
        /// <returns></returns>
        MaxSubArray MaxSumSubArrayBF(int[] arr)
        {
        ...
        /// <param name="arr"></param>
        /// <returns></returns>
        MaxSubArray MaxSumSubArrayBFImproved(int[] arr)
        {
            MaxSubArray result = new MaxSubArray();
        ...
        /// <returns></returns>
        MaxSubArray MaxSumSubArrayRecursion(int[] arr, int start, int end)
        {
            if (start == end)
            {
        ...
        private MaxSubArray GetMaxMiddle(int[] arr, int start, int end, int mid)
        {
            int leftSum = 0;
            int leftMaxIndex = 0;
            for (int i = 0; i <= mid; i++)
        ...
        /// <param name="arr"></param>
        /// <returns></returns>
        MaxSubArray MaxSumSubArrayLinear(int[] arr)
        {
            int cumSum = 0;
            int maxSum = 0;
        ...
        MaxSubArray MaxSumSubArray(int[] arr)
        {
